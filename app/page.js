    ...
    <>
      ...
      <section id="skills" className="reveal mt-10 border-t border-[#1e293b] pt-10">
        <div className="space-y-2">
          <h2 className="reveal reveal-delay-1 text-xl font-semibold text-white sm:text-2xl">Skills</h2>
          <p className="reveal reveal-delay-2 text-[#93c5fd]">Principais tecnologias e ferramentas que utilizo no desenvolvimento backend.</p>
        </div>
        <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="reveal reveal-delay-1 glow-hover rounded-2xl border border-[#1e40af] bg-[#1e293b] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
            <div className="text-sm font-semibold text-white">☕ Java</div>
            <div className="mt-1 text-xs text-[#93c5fd]">POO, Streams, Collections</div>
            <div className="mt-3 h-2 w-full rounded-full bg-[#1e293b]">
              <div className="h-full rounded-full bg-gradient-to-r from-[#2563eb] to-[#93c5fd]" style={{ width: "90%" }} />
            </div>
          </div>
          <div className="reveal reveal-delay 2 glow-hover rounded-2xl border border-[#1e40af] bg-[#1e293b] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
            <div className="text-sm font-semibold text-white">🌱 Spring Boot</div>
            <div className="mt-1 text-xs text-[#93c5fd]">REST APIs, Security, Data</div>
            <div className="mt-3 h-2 w-full rounded-full bg-[#1e293b]">
              <div className="h-full rounded-full bg-gradient-to-r from-[#2563eb] to-[#93c5fd]" style={{ width: "85%" }} />
            </div>
          </div>
          <div className="reveal reveal-delay-3 glow-hover rounded-2xl border border-[#1e40af] bg-[#1e293b] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
            <div className="text-sm font-semibold text-white">🐳 Docker</div>
            <div className="mt-1 text-xs text-[#93c5fd]">Containers, Dockerfile, Compose</div>
            <div className="mt-3 h-2 w-full rounded-full bg-[#1e293b]">
              <div className="h-full rounded-full bg-gradient-to-r from-[#2563eb] to-[#93c5fd]" style={{ width: "70%" }} />
            </div>
          </div>
          <div className="reveal reveal-delay-4 glow-hover rounded-2xl border border-[#1e40af] bg-[#1e293b] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
            <div className="text-sm font-semibold text-white">🌿 Git</div>
            <div className="mt-1 text-xs text-[#93c5fd]">Branches, PRs e Git Flow</div>
            <div className="mt-3 h-2 w-full rounded-full bg-[#1e293b]">
              <div className="h-full rounded-full bg-gradient-to-r from-[#2563eb] to-[#93c5fd]" style={{ width: "82%" }} />
            </div>
          </div>
          <div className="reveal reveal-delay-5 glow-hover rounded-2xl border border-[#1e40af] bg-[#1e293b] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
            <div className="text-sm font-semibold text-white">🔗 API REST</div>
            <div className="mt-1 text-xs text-[#93c5fd]">Boas práticas, versionamento, DTOs</div>
            <div className="mt-3 h-2 w-full rounded-full bg-[#1e293b]">
              <div className="h-full rounded-full bg-gradient-to-r from-[#2563eb] to-[#93c5fd]" style={{ width: "84%" }} />
            </div>
          </div>
          <div className="reveal reveal-delay-6 glow-hover rounded-2xl border border-[#1e40af] bg-[#1e293b] p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
            <div className="text-sm font-semibold text-white">🗄️ SQL</div>
            <div className="mt-1 text-xs text-[#93c5fd]">Modelagem, consultas, índices</div>
            <div className="mt-3 h-2 w-full rounded-full bg-[#1e293b]">
              <div className="h-full rounded-full bg-gradient-to-r from-[#2563eb] to-[#93c5fd]" style={{ width: "78%" }} />
            </div>
          </div>
        </div>
      </section>
